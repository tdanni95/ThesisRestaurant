...
namespace ThesisRestaurant.Infrastructure.Migrations
{
    ...
    [Migration("20230314142656_OrderPlusIngredientFix")]
    partial class OrderPlusIngredientFix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ThesisRestaurant.Domain.Orders.OrderAdditionalIngredients.OrderAdditionalIngredient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("OrderAdditionalIngredient");
                });
            ...
            modelBuilder.Entity("ThesisRestaurant.Domain.Orders.OrderAdditionalIngredients.OrderAdditionalIngredient", b =>
                {
                    b.HasOne("ThesisRestaurant.Domain.Ingredients.Ingredient", "Ingredient")
                        .WithMany()
                        .HasForeignKey("IngredientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ThesisRestaurant.Domain.Orders.OrderItems.OrderItem", null)
            ...
            modelBuilder.Entity("ThesisRestaurant.Domain.Orders.OrderItems.OrderItem", b =>
                {
                    ...
                    b.HasOne("ThesisRestaurant.Domain.FoodTypes.FoodSizes.FoodSize", "FoodSize")
                        .WithMany()
            ...
            modelBuilder.Entity("ThesisRestaurant.Domain.Users.User", b =>
                {
                    b.OwnsOne("ThesisRestaurant.Domain.Users.RefreshTokens.RefreshToken", "RefreshToken", b1 =>
                        {
